...
class LoanTestCase(TestCase):
    ...
    def test_desired_monthly_payment(self):
        ...
        """
        monthly_loan = LoanSimulation.objects.create(amount=10000, desired_monthly_payment=10)
    ...
    def test_duration(self):
        ...
        """
        duration_loan = LoanSimulation.objects.create(amount=10000, duration=36)
    ...
    def test_cannot_set_monthly_and_duration(self):
        ...
        """
        loan = LoanSimulation.objects.create(amount=10000, duration=36, desired_monthly_payment=10)
    ...
    def test_must_set_monthly_or_duration(self):
        ...
        """
        loan = LoanSimulation.objects.create(amount=1000)
        with self.assertRaises(ValidationError):
            loan.full_clean()